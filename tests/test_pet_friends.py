...
def test_successful_update_self_pet_info(name='Алекс', animal_type='Котенок', age=4):
...
def test_get_api_key_with_wrong_email(email=valid_email, password='812567'):
...
#2
def test_get_api_key_with_wrong_email(email='aaliassafiullina@yandex.ru', password=valid_password):
...
#8
def test_add_pet_with_numbers_in_variable_animal_type(name='Муся', animal_type='111111111', age='3'):
